...
const REPLACE_CODES = { CHAR_TILDE: CODE_FNC1 }; // ~ corresponds to FNC1 in GS1-128 standard
const CODESET = {
  ANY: 1,
  AB: 2,
  A: 3,
...
const BrCode128 = function (ctx, text, width, height) {
